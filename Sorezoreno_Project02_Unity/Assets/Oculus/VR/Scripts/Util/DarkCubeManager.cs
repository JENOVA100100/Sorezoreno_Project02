...
//UmweltManagerでON/OFF切り替えしているので使用していません(23/01/2021)
public class DarkCubeManager : MonoBehaviour
{
    ...
    //[SerializeField]private string HowUmwelt; //class string型のpublic変数 HowMoveを宣言。(29/12/2020)
    ...
    void Update()
    {
        ...
        if(manager.MainUmwelt == "worm")
        {
            darkcube.SetActive(true);
        }else if (manager.MainUmwelt == "chicken")
        {
